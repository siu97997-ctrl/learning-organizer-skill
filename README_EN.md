...
The public version contains no personal Notion address, account information, or fixed knowledge taxonomy and can be reused across different learning domains.
